...
$this->title = Yii::t('main', 'News Categories');
        ...
        <div class="panel-body no-padding">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body page-header-block">
                    ...
                    <?= Html::a(Yii::t('main', 'Create Category'), ['/news-category/create'], ['class' => 'btn btn-success']) ?>
...
BUTTONS;
                ...
                <div class="row index-footer">
                    <div class="col-md-6">
                        ...
                        <?php\yii\widgets\ActiveForm::begin(['action' => '/news-category/index']);?>
