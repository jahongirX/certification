        ...
        <div class="panel-body no-padding">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body page-header-block">
                    ...
                    <?= Html::a(Yii::t('main', 'Add News'), ['/news/create'], ['class' => 'btn btn-success']) ?>
			    			...
			    			<?= GridView::widget([
			                    ...
			                    'columns' => [
						            ...
						            [
	                                    ...
	                                    'contentOptions' => ['class' => 'v-align-middle'],
                                        'content' => function($model){
                                            return StaticFunctions::getPartOfText($model->title, 100);
                                        }
						            ],
                                    [
                                        'attribute' => 'category',
                                        ...
                                        'content' => function($model)
                                        {
                                            if( isset( $model->categoryName->name ) )
