                        ...
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    ...
                                    'format' => 'Ntext',
                                    'content' => function($data){
                                        return htmlentities(StaticFunctions::getPartOfText($data['ru']['translation'], 25));
                                    }
                                ],
                                [
                                    'attribute' => 'English',
                                    ...
                                    'format' => 'Ntext',
                                    'content' => function($data){
                                        return htmlentities(StaticFunctions::getPartOfText($data['en']['translation'], 25));
                                    }
                                ],
                                [
...
BUTTONS;
                ...
                <div class="row index-footer">
                    <div class="col-md-6">
                        ...
                        <?php \yii\widgets\ActiveForm::begin(['action' => '/source-message/index']);?>
